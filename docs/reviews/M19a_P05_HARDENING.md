...
**Date:** 2026-08-18  
**Parent:** [`M19a_P0_LIFE_CAPTURE.md`](../modules/M19a_P0_LIFE_CAPTURE.md) v1.6  
**Automated:** `pytest tests/test_m19a_food_reference.py tests/test_m19a_hud_edge_smoke.py -q`
...
**Prereqs:** Agent session + login; `ada life gym-import-seed`; USDA key in `secrets/usda_fdc.env` for banana detail test.
...
| 5 | HUD Agent: `log lift: pull-ups x8` | `life_lift_log` receipt; set row `load_kg` null; catalog **Pull-up** |
